...
const Modal = () => {
    ...
    return (
        ...
        <>
  <button onClick={openmodal} className="modal-open bg-transparent border border-gray-500 hover:border-indigo-500 text-gray-100 hover:text-indigo-100 font-bold py-2 px-4 rounded-full">Open Modal</button>

<div className="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
    <div  onClick={openmodal} className="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
